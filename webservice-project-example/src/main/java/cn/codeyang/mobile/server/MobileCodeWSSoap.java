...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "cn.codeyang.mobile.server.GetMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.codeyang.mobile.server.GetMobileCodeInfoResponse")
     ...
     * 
     * @return
     *     returns cn.codeyang.mobile.server.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getDatabaseInfo", targetNamespace = "http://WebXml.com.cn/", className = "cn.codeyang.mobile.server.GetDatabaseInfo")
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "cn.codeyang.mobile.server.GetDatabaseInfoResponse")
