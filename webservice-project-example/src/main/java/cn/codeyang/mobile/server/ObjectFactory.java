...
package cn.codeyang.mobile.server;
 ...
 * generated in the cn.codeyang.mobile.server package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.codeyang.mobile.server
     * 
     */
