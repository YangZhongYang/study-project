 ...
 * 2016-03-08T11:11:28.889+08:00
 * Generated source version: 2.7.18
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", 
                  wsdlLocation = "http://127.0.0.1:12345/weather?wsdl",
                  targetNamespace = "http://server.cxf.codeyang.cn/") 
public class WeatherInterfaceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server.cxf.codeyang.cn/", "WeatherInterfaceService");
    public final static QName WeatherInterfacePort = new QName("http://server.cxf.codeyang.cn/", "WeatherInterfacePort");
    static {
        URL url = null;
        try {
