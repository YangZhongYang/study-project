 ...
 * generated in the cn.codeyang.cxf.weather package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://server.cxf.codeyang.cn/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://server.cxf.codeyang.cn/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.codeyang.cxf.weather
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.codeyang.cn/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.cxf.codeyang.cn/", name = "queryWeatherResponse")
