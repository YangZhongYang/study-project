 ...
 * 2016-03-08T15:59:51.862+08:00
 * Generated source version: 2.7.18
 * 
 */
@WebServiceClient(name = "WeatherInterfaceService", 
                  wsdlLocation = "http://localhost:8080/spring-cxf-server/ws/weather?wsdl",
                  targetNamespace = "http://server/") 
public class WeatherInterfaceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server/", "WeatherInterfaceService");
    public final static QName WeatherInterfacePort = new QName("http://server/", "WeatherInterfacePort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/spring-cxf-server/ws/weather?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(WeatherInterfaceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/spring-cxf-server/ws/weather?wsdl");
        }
        WSDL_LOCATION = url;
    }
