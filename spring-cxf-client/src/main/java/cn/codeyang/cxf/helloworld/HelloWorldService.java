 ...
 * 2016-03-08T15:53:28.222+08:00
 * Generated source version: 2.7.18
 * 
 */
@WebServiceClient(name = "HelloWorldService", 
                  wsdlLocation = "http://localhost:8080/spring-cxf-server/ws/HelloWorld?wsdl",
                  targetNamespace = "http://server/") 
public class HelloWorldService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://server/", "HelloWorldService");
    public final static QName HelloWorldPort = new QName("http://server/", "HelloWorldPort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/spring-cxf-server/ws/HelloWorld?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWorldService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/spring-cxf-server/ws/HelloWorld?wsdl");
        }
        WSDL_LOCATION = url;
    }
